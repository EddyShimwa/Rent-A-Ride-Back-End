...
RSpec.describe Rental, type: :model do
  subject do
    ...
    Car.create(name: 'Chevrolet Silverado', model: '1500 Custom', description: 'Popular full-size pickup truck manufactured by General Motors under the Chevrolet brand.', car_image_url: 'www.example.png', rating: 2, price: 70.6, rent_per_day: 98.99,
               user_id: myuser.id)
  end
  before { subject.save }
